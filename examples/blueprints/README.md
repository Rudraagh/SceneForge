...
These images use the same RGB palette as `blueprint_parser.DEFAULT_COLOR_MAP` (brown ≈ desk/table, blue ≈ chair, green ≈ blackboard, darker brown ≈ bookshelf, gold ≈ lamp) on a white background so `parse_blueprint()` can detect regions.
...
| `blueprint_b02_home_rooms.png` | b2 — Living + kitchen zones; table, desk, chairs, board, shelf |
| `blueprint_b03_lecture_hall.png` | b3 — Lecture hall grid; board band + desk/chair rows + lamps |
